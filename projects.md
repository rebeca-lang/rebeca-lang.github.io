...
<div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/DistributedControllers/nrpTop50.jpg" | absolute_url }}" alt="Consistency of Distributed Controllers"/></h2>
  ...
  <div class="col s12 m4">
    <div class="icon-block">
      ...
      <p class="light">
        Rebeca2LF is a framework for synthesis of Timed Rebeca models using Lingua Franca. <a href="{{ "/allprojects/Rebeca2LF" | relative_url }}">Learn more</a>
      </p>
    </div>
  </div>
...
<div class="row">
  <div class="col s12 m4">
    <div class="icon-block">
      ...
      <h5 class="center">RoboRebeca: Dependble ROS application</h5>
      <p class="light">
...
<div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/LegatatoRebeca/DefaultProject.jpg" | absolute_url }}" alt="Legata to Rebeca"/></h2>
...
<div class="row">
   ...
   <div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/RebecAI/DefaultProject.jpg" | absolute_url }}" alt="RebecAI"/></h2>
