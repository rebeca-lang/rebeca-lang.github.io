...
<div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/DistributedControllers/nrpTop.pdf" | absolute_url }}" alt="CRYSTAL Logo"/></h2>
      <h5 class="center">Consistency of Controllers</h5>
      <p class="light">
