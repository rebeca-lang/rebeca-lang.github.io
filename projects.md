...
<div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/LegatatoRebeca/Legata2Rebeca-p.png" | absolute_url }}" alt="Legata to Rebeca"/></h2>
...
<div class="row">
   ...
   <div class="col s12 m4">
    <div class="icon-block">
      <h2 class="center light-blue-text"><img src="{{ "/assets/projects/RebecAI/RebecAI-p.png" | absolute_url }}" alt="RebecAI"/></h2>
