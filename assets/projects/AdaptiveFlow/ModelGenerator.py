...
def extractTopologyData(root, environment):
    POIs = {}
    index = 0
...
MAX_TRACK_LENGTH = str(rows + columns)


# In[69]:


topology = extractTopologyData(root_file['topology'],environment)
#topology
